...
$city=$_POST["city"];
$state=$_POST["state"];
$conn = new PDO("sqlsrv:server = localhost; Database = testdb", "root", " ");
...
<body> 
<a href="."><button style="position: absolute;top:0;left:0; z-index: 60; height:auto; width:auto;background-color:transparent;border:none;color:white;"><i class="fa fa-home fa-2x" aria-hidden="true";></i></button></a>
            ...
            if (status != google.maps.DistanceMatrixStatus.OK) {
                ...
                if (response.rows[0].elements[i].status === "ZERO_RESULTS") {
                   ...
                   /* var distance_in_mile = distance.value / 1609.34; // the mile
                    ...
                    str=str+"<a class='link' target='if"+size+"' href='./geocoding_services.php?"+query+"'>Click</a><br>";
                    ...
                    str+="<a class='link_date' href='./date.php?"+query2+"'>Pick a Date and Time</a><br>";
