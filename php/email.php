...
$pass1 = '_';
$to=$email;
$message="Your temporary password for BLISS.. is <b>".$pass."</b>.<br>We recommend you to change this temporary password by going to the link below.<br><br>./login.php";
$params = array(
     'api_user' => $user,
     'api_key' => $pass1,
     'to' => $to,
