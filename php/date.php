...
<a href='./mail_confirmation.php?address=$useraddress&name=$user_name&mail=$user_mail&user_city=$user_city&phone=$user_phone&date=$date&time=$time&distancetaken=$distance_taken2&timetaken=$time_taken2&ngoname=$ngoname&ngomail=$ngoemail&ngophone=$phonengo&ngoaddress=$ngoaddress'><b>CONFIRM</b></a></p>";
$params = array(
     'api_user' => $user,
     'api_key' => $pass,
     'to' => $ngoemail,
...
<body> 
<a href="."><button style="position: absolute; z-index: 60; height:auto; width:auto;background-color:transparent;border:none;color:white;"><i class="fa fa-home fa-2x" aria-hidden="true"></i></button></a>
