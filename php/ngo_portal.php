        ...
        <div class="contain_para_image4">
            ...
            <div id="tabs-1">
              <p>Here you can accept/reject requests from the users who have chosen  your organisation as their first
                ...
                <br>
                    ...
                    <br>
                    <br>
                    <a href="./pending_requests.php" style="text-decoration:none;"><input type="button" id="tab-button" value="PROCEED"></a>
            ...
            <div id="tabs-2">
                ...
                <br>
                    ...
                    <br>
                    <br>
                <a href="./floating_requests.php" style="text-decoration:none;"><input type="button" id="tab-button" value="PROCEED"></a>
            ...
            <div id="tabs-3">
                <p>
                    ...
                    <a href="./updateInfo.php" style="text-decoration:none;"><input type="button" id="tab-button" value="PROCEED"></a>
