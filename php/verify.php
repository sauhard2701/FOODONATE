...
function test_input($data) {
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $conn = new PDO("sqlsrv:server = 127.0.0.1; Database = testdb", "root", " ");
...
$pass1 = '_';
$to=$email;
$message="Your one time password for FOODONATE is <b>".$pass."</b>.
<br>Enter the OTP to get register yourself with FOODONATE.<br><br>Regards,<br>Team FOODONATE";
$params = array(
     'api_user' => $user,
     'api_key' => $pass1,
     'to' => $to,
...
<link rel="icon" href="favicon.ico" type="image/x-icon">
  <title>E-Mail Verification - FOODONATE</title>
